...
class TrustedDomainHelperTest extends \Test\TestCase {
	 ...
	 * @param bool $result
	 */
	public function testIsUrlTrustedDomain($trustedDomains, $testDomain, $result) {
		...
		$this->assertEquals($result, $trustedDomainHelper->isUrlTrustedDomain('https://' . $testDomain . '/index.php/something'));
	}
